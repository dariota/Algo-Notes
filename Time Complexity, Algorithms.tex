...
\tikzstyle{bnode} = [circle, minimum width=1cm, minimum height=1cm,text centered, draw=blue, fill=black!30]
\tikzstyle{rnode} = [circle, minimum width=1cm, minimum height=1cm,text centered, draw=blue, fill=red!30]
\tikzstyle{node} = [circle, minimum width=1cm, minimum height=1cm,text centered, draw=blue, fill=white!30]
\tikzstyle{leaf} = [circle, minimum width=1cm, minimum height=1cm,text centered, draw=black, fill=black!30]
